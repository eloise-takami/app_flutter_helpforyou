                            ...
                            onPressed:(){
                              ...
                              return Container(
                                  ...
                                  child: Column(children: [
                                     ...
                                     child: Center(
                                     child: Text("Delegacia da polícia de Paulínia",
                                  ...
                                  Row(children: [   
                                    ...
                                    SizedBox(width: 20,),
                                    Text('          Av. José Paulino, 1406 - Nova Paulínia, \n          Paulínia - SP, 13140-000',
                                     style: GoogleFonts.breeSerif(
                                     textStyle: Theme.of(context).textTheme.headline4,
                                     fontSize: 17,
                                     fontWeight: FontWeight.w900,
                                  ...
                                  // Image(image: AssetImage("lib/assets/del_pol_paulinia.jpg"),
                                  // height: 30,
                                  // ),
                                  ],
                                  ),
